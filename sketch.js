...
var racketSprite = false;
var broomCollected= false;
var catCollected= false;
var necklaceCollected= false;
var knifeCollected= false;
var phoneCollected= false;
var racketCollected= false;
function preload(){
...
function draw() {
  ...
  if(level === 1 && gameState === "play"){
    ...
    //if(roomObjsCollected === 10){
      //gameState = "end";
    //}
    if(bagCollected === true && socksCollected === true && scarfCollected === true && knifeCollected ===true && broomCollected == true 
      && catCollected === true && fruitsCollected ===true && necklaceCollected ===true && phoneCollected === true && racketCollected ===true){
      gameState ="end";
    }
  }
